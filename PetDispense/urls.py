...
urlpatterns = patterns('',
                       ...
                       url(r'^logout/$', 'PetDispense.views.logout_user', name=u"logout"),
                       ...
                       url(r'^results_owners/$', 'PetDispense.views.search_owners', name=u"search_owners"),
                       url(r'^results/$', 'PetDispense.views.search', name=u"search"),
                       url(r'^dispense/$', 'PetDispense.views.dispense', name=u"dispense"),
